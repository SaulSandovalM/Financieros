...
//               </div>
//               <div className='df-t'>
//                 <p className='t-cajas'>Baja<img className='svg' src={boton} alt=''/></p>
//                 <p className='t-cajas'>Archivo historico<img className='svg' src={boton} alt=''/></p>
//                 <p className='t-cajas'>Muestreo<img className='svg' src={boton2} alt=''/></p>
//              </div>
//           </div>
