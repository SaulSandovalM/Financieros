...
export default class Comprometidos extends Component {
  ...
  area = [
    ...
    { text: 'Dirección General para la Atención del Sistema Tradicional', value: '04' },
    { text: 'Fiscalia Especializada en Delitos Electorales', value: '05'},
    { text: 'Subprocuraduría de Derechos Humanos y Servicios a la Comunidad', value: '06'},
    { text: 'Centro de Justicia Restaurativa Penal Poniente', value: '07' },
    { text: 'Fiscalía para la Atención de Delitos de Género', value: '08'},
    { text: 'Visitaduría General', value: '09'},
    { text: 'Dirección General de Servicios Periciales', value: '10'},
    { text: 'Centro de Operación Estratégica', value: '11'},
    { text: 'Unidad Especializada en el Combate al Secuestro', value: '12'},
    { text: 'Dirección General de Administración y Finanzas', value: '13'},
    { text: 'Fiscalía Especializada para la atención de los Delitos de Trata de Personas', value: '14'},
    { text: 'Subprocuraduría de Procedimientos Penales Región Poniente', value: '15'},
    { text: 'Centro de Atención Temprana Poniente', value: '16'},
    { text: 'Dirección General de Investigación y Litigación Poniente', value: '17'},
    { text: 'Dirección General de la Policía Investigadora', value: '18'},
    ...
    { text: 'Fiscalía Especializada en Delitos de Corrupción', value: '23'},
    { text: 'Fiscalía de Desaparición Forzada y Desaparición por Terceros', value: '24' },
  ]
  ...
  render () {
    ...
    let resultp = presupuestop.sort((a, b) => a - b).filter((item, index) => {
