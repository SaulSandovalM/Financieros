...
export default class ListComponent extends Component {
  ...
  removeComprometido = () => {
    this.props.removeComprometido(this.props.comprometido.id)
  }
    ...
    return (
      <TableBody>
        <TableRow>
          ...
          <TableCell className='border-icon'>
            <IconButton aria-label='expand row' size='small' className='border-del' onClick={this.removeComprometido}>
