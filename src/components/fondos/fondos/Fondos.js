...
export default class Fondos extends Component {
  ...
  componentDidMount() {
    ...
    const itemsRefBeneficiario = firebase
      .database()
      .ref("beneficiario/")
      .orderByChild("nombre");
  ...
  crearFondo(e) {
    ...
    if (
      ...
      params.fechaDepo &&
      params.cuentaPagar &&
      params.cuentaPagarPara &&
      params.sujetoContable &&
      params.comprometido &&
      params.cpa &&
      params.anexof
    ) {
                  ...
                  <div className="div-conn">
                    ...
                    <div style={{ width: "40%" }}>
                      ...
                      <input
                        ...
                        onChange={this.onChange}
                        ref={(otherOficio) =>
                          (this.inputOtherOficio = otherOficio)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="div-con">
                    ...
                    realizo === "LAURA" ? (
                      <input
                        ...
                        disabled
                        ref={(requisicion) =>
                          (this.inputRequisicion = requisicion)
                        }
                      />
                    ) : (
                      <input
