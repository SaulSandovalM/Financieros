                  ...
                  <div className='oat-content'>
                    ...
                    <div className='a-w'>
                      ...
                      <select
                        ...
                        required
                      >
                        <option name='area'>{currentVale.area}</option>
                        <option name='area'>Despacho del Procurador</option>
                        <option name='area'>Subprocuraduría de Procedimientos Penales Región Oriente</option>
                        <option name='area'>Fiscalía Especializada para la atención de Delitos cometidos contra la Libertad de Expresión</option>
                        <option name='area'>Periodistas y Personas defensoras de los Derechos Humanos</option>
                        <option name='area'>Dirección General para la Atención de los Asuntos del Sistema Tradicional</option>
                        <option name='area'>Fiscalia de Delitos Electorales</option>
                        <option name='area'>Subprocuraduría de Derechos Humanos y Servicios a la Comunidad</option>
                        <option name='area'>Centro de Justicia Restaurativa Penal Poniente</option>
                        <option name='area'>Fiscalía para la Atención de Delitos de Género</option>
                        <option name='area'>Visitaduría General</option>
                        <option name='area'>Dirección General de Servicios Periciales</option>
                        <option name='area'>Centro de Operación Estratégica</option>
                        <option name='area'>Unidad Especializada en el Combate al Secuestro</option>
                        <option name='area'>Dirección General de Administración y Finanzas</option>
                        <option name='area'> - Dirección de Planeacion</option>
                        <option name='area'> - Dirección de Control y Validación</option>
                        <option name='area'> - Dirección de Informatica, Estadistica y Telecomunicaciones</option>
                        <option name='area'> - Dirección de Recursos Materiales</option>
                        <option name='area'> - Dirección de Recursos Humanos</option>
                        <option name='area'> - Dirección de Enlace FASP</option>
                        <option name='area'> - Dirección de Coordinacion de Calidad</option>
                        <option name='area'> - Dirección de Archivo</option>
                        <option name='area'> - Oficialia de Partes</option>
                        <option name='area'>Fiscalía Especializada para la atención de los Delitos de Trata de Personas</option>
                        <option name='area'>Subprocuraduría de Procedimientos Penales Región Poniente</option>
                        <option name='area'>Centro de Atención Temprana Poniente</option>
                        <option name='area'>Dirección General de Investigación y Litigación Poniente</option>
                        <option name='area'>Dirección General de la Policía Investigadora</option>
                        <option name='area'>Centro de Atención Temprana Oriente</option>
                        <option name='area'>Centro de Justicia Restaurativa Penal Oriente</option>
                        <option name='area'>Dirección General de Investigación y Litigación Oriente</option>
                        <option name='area'>Dirección General de Recursos Materiales y Servicios</option>
                        <option name='area'>Fiscalía Especializada en Delitos de Corrupción</option>
                        <option name='area'>Fiscalía Especializada en Materia de Desaparición Forzada de Personas</option>
                      </select>
                    </div>
                    <div className='t-w'>
