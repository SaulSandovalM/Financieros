...
export default class Seleccion extends Component {
  ...
  sendMessage(e) {
    ...
    if ( params.ramo && params.ingresos && params.importe && params.proyecto && params.clave) {
      ...
      <div className='pf-container'>
        ...
        <div className='p-container-fr'>
          <div className='p-margin-row'>
            <p className='p-title-size'>- Agrega el documento de autorización de fondo revolvente</p>
            <div>
        ...
        <form onSubmit={this.sendMessage.bind(this)} ref='contactForm'>
          <div className='p-container'>
            <div className='p-margin-f'>
              <p className='p-title-size'>- Ingresa los datos que correspondan con el documento de autorización del fondo revolvente</p>
            </div>
            <div className='p-row2'>
              <div className='p-container-i2' >
                <p className='p-title-margin2'>Ramo</p>
                <input className='input-h' id='ramo' ref={ramo => this.inputRamo = ramo} />
              </div>
              <div className='p-container-i2' >
                <p className='p-title-margin2'>R. de Ingresos</p>
                <input className='input-h' id='ingresos' ref={ingresos => this.inputIngresos = ingresos} />
              </div>
              <div className='p-container-i2' >
                <p className='p-title-margin2'>Importe</p>
                <input className='input-h' id='importe' ref={importe => this.inputImporte = importe} />
              </div>
            </div>
            <div className='p-col'>
              <div className='p-container-i3' >
                <p className='p-title-margin2'>Proyecto</p>
                <input className='input-h' id='proyecto' ref={proyecto => this.inputProyecto = proyecto} />
              </div>
              <div className='p-container-i3' >
                <p className='p-title-margin2'>Clave</p>
                <input className='input-h' id='clave' ref={clave => this.inputClave = clave} />
              </div>
            </div>
          </div>
