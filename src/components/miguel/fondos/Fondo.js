        ...
        <Grid container spacing={3}>
          <Grid item xs={6}>
            <Paper style={{padding: '20px'}}>
              <div style={{ marginBottom: '15px' }}>Fondos</div>
              <TextField
                className='field'
              ...
              <TextField
                ...
                value={today}
              />
              <FormControl className='field' style={{ marginBottom: '15px' }}>
                <InputLabel>Tipo de Documento</InputLabel>
                <Select
                  name='tipoDoc'
                  value={tipo_doc}
                  onChange={event => this.handleChangeT(event.target.value)}
                  input={<Input />}
                >
                  {this.tipo_doc.map((name) => (
              ...
              <FormControl className='field' style={{ marginBottom: '15px' }}>
                <InputLabel>Oficio de Autorización</InputLabel>
                <Select
                  name='oficio_aut'
                  value={oficio_aut}
                  onChange={event => this.handleChangeO(event.target.value)}
                  input={<Input />}
                >
                  {this.oficio_aut.map((name) => (
                    <MenuItem key={name} value={name}>
                      {name}
                    </MenuItem>
                  ))}
...
{/* <div>
  <div>
    <Grid container spacing={2}>
      <Grid item xs={6}>
        <Paper className='card-fondo-con' elevation={3} style={{ width: '100%' }}>
          <TextField
            className='field'
            style={{ marginBottom: '15px' }}
            label='Fondo'
      ...
      <Grid item xs={6}>
        <Paper className='card-fondo-con2' elevation={3}>
          <TextField
            className='field'
            style={{ marginBottom: '15px' }}
            label='No. de Licitación'
  ...
  <div className='div-content-fab'>
    <Fab color='primary' style={{ backgroundColor: 'green' }}>
      <CheckIcon />
    </Fab>
  </div>
</div> */}
