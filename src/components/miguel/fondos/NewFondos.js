...
export default class Fondos extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { fondo, fecha, tipo_doc, oficio_aut, no_oficio, no_lici, importe, desc,
            beneficiario, realizo, requisicion, pedido, no_proyecto, poliza,
  ...
  render () {
    ...
    return (
      <form style={{ display: 'flex', justifyContent: 'center', width: '100%', paddingTop: '80px', backgroundColor: '#f4f4f4', minHeight: '91.5vh' }} onSubmit={this.onSubmit}>
        <Grid  style={{ width: '70%' }}>
            ...
            <Paper style={{ padding: '20px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Fondo</p>
                  <input
                    className='field'
                ...
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Fecha</p>
                  <input
                    className='field'
                    style={{ marginBottom: '20px' }}
                    required
              ...
              <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Tipo de Documento</p>
                  {admin === 'ADMIN' &&
                    <DropDownList
                      suggest
                      style={{
                ...
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Oficio de Autorización</p>
                  <DropDownList
                    suggest
                    style={{
                      borderColor: 'grey',
              ...
              <div style={{ marginBottom: '20px', display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Numero de Oficio</p>
                  <input
                    className='field'
                    name='no_oficio'
                    onChange={this.onChange}
                ...
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Importe</p>
                  <input
                    className='field'
                    name='importe'
                    value={importe}
              ...
              <div style={{ marginBottom: '20px', display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Importe Letra</p>
                  <input
                    className='field'
                    name='no_oficio'
                    onChange={this.onChange}
                ...
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Beneficiario</p>
                  <DropDownList
                    suggest
                    style={{
                      borderColor: 'grey',
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Descripción</p>
                  <input
                    className='field'
                    id='desc'
                    name='desc'
                ...
                <div style={{ width: '48%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Proyecto</p>
                  <DropDownList
                    suggest
                    style={{
                      borderColor: 'grey',
            ...
            <Paper style={{ padding: '20px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
                <div style={{ width: '46%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Numero de Licitación</p>
                  <input
                    className='field'
                    id='no_lici'
                    name='no_lici'
                ...
                <div style={{ width: '46%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Requisición</p>
                  <input
                    className='field'
                    id='requisicion'
                    name='requisicion'
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '46%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Pedido</p>
                  <input
                    className='field'
                    id='pedido'
                    name='pedido'
                ...
                <div style={{ width: '46%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Poliza</p>
                  <input
                    className='field'
                    id='poliza'
                    name='poliza'
            ...
            <Paper style={{ padding: '20px', marginTop: '20px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ width: '30%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Cta CFE</p>
                  <input
                    className='field'
                    id='cfe'
                    name='cfe'
                ...
                <div style={{ width: '30%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Numero de Servicio CFE</p>
                  <input
                    className='field'
                    id='nscfe'
                    name='nscfe'
                ...
                <div style={{ width: '30%', display: 'flex', flexDirection: 'column' }}>
                  <p style={{ margin: '0', color: 'grey', fontSize: '12px' }}>Observaciones</p>
                  <input
                    className='field'
                    id='observaciones'
                    name='observaciones'
