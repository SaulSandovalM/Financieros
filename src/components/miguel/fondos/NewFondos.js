...
export default class Fondos extends Component {
  constructor (props) {
    super(props)
    this.ref = firebase.firestore().collection('fondos').orderBy('fondo')
              ...
              <div className='space-seach'>
                ...
                {this.state.fondos.map(fondos =>
                  <div className='fondo-t-s2 '>
                    ...
                    <div>
                      <div className='fon-tab-ba'>
                        <p className='fon-p-c'>{fondos.fondo}</p>
                      </div>
                      <div className='fon-tab-ba'>
                        <p className='fon-p-c'>{fondos.tipo_doc}</p>
                      </div>
                      <div className='fon-tab-ba'>
                        <p className='fon-p-c'>{fondos.importe}</p>
                      </div>
                      <div className='fon-tab-ba'>
                        <p className='fon-p-c'>{fondos.fecha}</p>
                      </div>
                      <div className='fon-tab-ba'>
                        <p className='fon-p-c'>{fondos.contrarecibo}</p>
                      </div>
                    </div>
                    }
                  </div>
