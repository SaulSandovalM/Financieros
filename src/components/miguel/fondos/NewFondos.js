...
export default class Fondos extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { fondo, fecha, tipo_doc, oficio_aut, no_oficio, no_lici, importe, desc,
            ...
            cfe, nscfe, observaciones, numCompro, cfdi, no_proyecto } = this.state
    this.ref.add({
      fondo,
      fecha,
      tipo_doc,
  ...
  no_proyecto = ['A1D11', 'AU001', 'AU002', 'AU003', 'AU004', 'AU005', 'AU007','AU009','AU010','AU011','AU012','AU014','AU015','AU016','AU017','AU018','AU019','AU020','AU021','AU023','AU024','AU025','AU026','AU027']
        ...
        <div className='m-f'>
              ...
              <div className='space-seach'>
                ...
                {this.state.fondos.map(fondos =>
                  <div>
                    ...
                    <div className='fondo-t-s2'>
                      <div className='fon-tab-ba-con'>
                        <p className='fon-p-con'>{fondos.fondo}</p>
                      </div>
                      <div className='fon-tab-ba-con'>
                        <p className='fon-p-con'>{fondos.tipo_doc}</p>
                      </div>
                      <div className='fon-tab-ba-con'>
                        <p className='fon-p-con'>{fondos.importe}</p>
                      </div>
                      <div className='fon-tab-ba-con'>
          ...
          <form onSubmit={this.onSubmit}>
            <div className='f-f-c-w'>
              ...
              <div className='f-f'>
                <div className='f-ff'>
                  <p className='fpb'>No. de Proyecto</p>
                  <DropDownList
                    suggest
                    style={{
                      borderColor: 'rgba(0,0,0,0.42)',
