  ...
  render () {
    ...
    return (
      <div>
        ...
        <div ref={el => (this.sol = el)} style={{ zIndex: '2', position: 'absolute', width: '100%' }}>
        ...
        <div className='pppdf-subdad' ref={el => (this.opp = el)} style={{ zIndex: '2', position: 'absolute' }}>
          ...
          <div className='texto-ofi_ppp'>
            <p>
              Por este medio me permito enviar a Usted documentación por un importe total de $ {this.state.fondo.importe}
