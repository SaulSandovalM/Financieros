    ...
    return(
      <div className='fecha'>
        <div className='subdad' ref={el => (this.holi= el)}>
          <div className='bueno'>
            <p className='texto-de-pdf' >Bueno por: {this.state.fondo.importe}</p>
          </div>
          ...
          <div className='fecha'>
            <p className='texto-de-pdf'>Pachuca de Soto, Hgo a {today}</p>
          </div>
          <div className='refe'>
            <p className='texto-de-pdf'>DIRECTOR GENERAL DE<br/>ADMINISTRACIÓN Y FINANZAS</p>
          </div>
          <div className='firma-dad-r'>
            <div className='firma-raya-r'>
              <p className='texto-de-pdf' style={{textAlign:'center'}}>MTRO. LEÓN MAXIMILIANO HERNÁNDEZ VALDÉS<br/>R.F.C.: HEVL-750104</p>
            </div>
          </div>
        </div>
        <ReactToPrint
