...
export default class ArqueoD extends Component {
  constructor (props) {
    ...
    this.state.before = dias[aa.getUTCDay()] + [aa.getDate() + 1] + ' de ' + meses[aa.getMonth()] + ' de ' + aa.getFullYear()
              ...
              <div>
                {this.state.searchF === item.fecha &&
                  <div className='ar-pad' ref={el => (this.arqueo = el)}>
                    ...
                    <div>
                      <ListComponentV
                        fechaSelect={this.state.searchF}
                        diaAnterior={this.state.lasrResult}
