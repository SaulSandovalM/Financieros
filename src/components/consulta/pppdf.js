...
<div class="texto-ofi">
                  <p>Por este medio me permito remitir a usted, facturas a nombre de Beneficiario "Comisión De Agua Potable, Alcantarillado Y Saneamiento Del Municipio De Ixmiquilpan, Hgo." {/*{this.state.}*/}
                  para su correspondiente trámite de pago; el monto total de las facturas asciende a la cantidad de Monto,
                  por concepto de pago a proveedor, correspondiente a Gasto de Operación según oficio de autorización OFICIO AUTORIZACION: 150/npd SSSY {/*{this.state.}*/}del Ejercicio 2020</p>
